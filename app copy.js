...
const basePath = path.join(__dirname, "./src/views/partials/base.ejs");
const headerPath = path.join(__dirname, "./src/views/partials/header.html");
const footerPath = path.join(__dirname, "./src/views/partials/footer.html");
const headerhPath = path.join(__dirname, "./src/views/partials/header-home.html");
const footerhPath = path.join(__dirname,"./src/views/partials/footer-home.html");
